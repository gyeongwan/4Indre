...
<body>
<bgsound src="sound/end.wav">
			<img src="/resources/img/end.jpg" alt="" height="725" width="726">	
			<img src="<%= request.getContextPath() %>/resources/img/end.jpg">	
						
<br>
<a href="#" onclick="moveClose();" id="ctnCode" data-code="KO1" class="btn">
