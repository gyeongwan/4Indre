...
<body>
<bgsound src="sound/start.wav">
<a href="popUpEnd" style="text-decoration:none">
<img src="/resources/img/bg_info2.jpg" alt="" height="700" width="700">	
<img src="<%= request.getContextPath() %>/resources/img/bg_info2.jpg">		
<br>
</a>
</body>
</html>