...
<body class="" data-aos-delay="0" data-aos-duration="800" data-aos-easing="slide" data-offset="300" data-target=".site-navbar-target" data-spy="scroll">
    ...
    <div class="site-wrap">
        ...
        <div id="sticky-wrapper" class="sticky-wrapper is-sticky" style="height: 91.9px;">
            <header class="site-navbar py-4 bg-white js-sticky-header site-navbar-target shrink" role="banner" style="width: 1519.2px; position: fixed; top: 0px; z-index: inherit;">
                        ...
                        <div class="col-12 col-md-10 d-none d-xl-block">
                            <nav class="site-navigation position-relative text-right" role="navigation">
                                ...
                                <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                                    ...
                                    <li><a href="doantionPage" class="nav-link">후원하기</a></li>
		...
		<div class="container inner-wrapper" style="text-align-last: center;">
	        <h2 class="error-code">잘못된 접근입니다.</h2>
	        <p class="error-message">해당 페이지에 에러가 발생하였습니다.</p>
	        <a href="#" onclick="history.back()" class="btn btn-primary">이전으로 돌아가기</a>
     	</div>     
        </section>
