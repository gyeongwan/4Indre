...
<html lang="en"><head>
 <title>디지털 학습 사이트</title>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/mPageLeaveStyle.css"/>">
    ...
    $(document).ready(function() {
			$("#btnCheck").click(function() {
				...
				document.checkForm.action = "userLeave.do"
...
<body class="" data-aos-delay="0" data-aos-duration="800" data-aos-easing="slide" data-offset="300" data-target=".site-navbar-target" data-spy="scroll">
    ...
    <div class="site-wrap">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="dntDetailsPage" class="nav-link">후원 내역</a>
            </li>
        </ul>
      </div>
...
">
                     <div class="doc-content-section-inner">
                         <h1>회원 탈퇴 <span class="sub-title">정말 탈퇴하시겠습니까?</span></h1>
							<form name="checkForm" method="post" action="#" class="first-ck" style="text-align: -webkit-center; padding-top: 30px;">
	                           <div class="form-group input-rounded">
                                   <input type="password" name="password" class="form-control" placeholder="계속하려면 비밀번호를 다시 입력해 주세요.">
                               </div>
                               <div class="form-inline">
                               </div>
                               <button type="submit" id="btnCheck" class="btn btn-primary btn-block"> 탈퇴하기 </button>
                           </form>
