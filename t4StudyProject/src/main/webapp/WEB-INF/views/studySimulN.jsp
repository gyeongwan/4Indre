...
<body class="" data-aos-delay="0" data-aos-duration="800" data-aos-easing="slide" data-offset="300" data-target=".site-navbar-target" data-spy="scroll">
    ...
    <div class="site-wrap">
        ...
        <div id="sticky-wrapper" class="sticky-wrapper" style="height: 118px;">
            <header class="site-navbar py-4 bg-white js-sticky-header site-navbar-target" role="banner" style="width: 670px;">
                        ...
                        <div class="col-12 col-md-10 d-none d-xl-block">
                            <nav class="site-navigation position-relative text-right" role="navigation">
                                ...
                                <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
				                  ...
				                  <li><a href="studyPageN" class="nav-link active">학습공간</a></li>
    ...
    <div class="header-fixed docs-body">
        <div class="doc-content-wrapper container">
            <div class="doc-aside">
                ...
                <ul class="nav">
                    <li class="nav-item">
                        <a href="studyPageN" class="nav-link">일반강좌</a>
                    </li>
                    <li class="nav-item">
                        <a href="studySimulN" class="nav-link active">실전 학습</a>
                    </li>
                </ul>
            </div>
            <div class="doc-content-section" id="getting-started">
                <div class="doc-content-section-inner">
                    <h1>실전 학습 <span class="sub-title">Simulation</span></h1>
														...
														<div class="gallery-item-box  col-321 start2 tran2">
                                                            <div class="gallery-item-wrap">
                                                                ...
                                                                <div class="gallery-title">
                                                                    <a href="ErrorNnot" id="ctn" data-code="${LIST[cnt].ctnCode}" title="${LIST[cnt].ctnName}">
                                                                     	${LIST[cnt].ctnName}</a>
                                                                </div>
